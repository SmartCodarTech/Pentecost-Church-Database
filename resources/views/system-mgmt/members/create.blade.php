                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h2><strong>Church Member details</strong> <small>Form</small></h2>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('members.store') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group {{ $errors->has('firstname') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="company" name="firstname" placeholder="E.g John">
                                    ...
                                    <div class="form-group {{ $errors->has('lastname') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="company" name="lastname" placeholder="E.g Doe">
                                    ...
                                    <div class="form-group {{ $errors->has('middlename') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="company" name="middlename" placeholder="E.g Ama optional">
                                    ...
                                    <div class="form-group {{ $errors->has('age') ? ' has-error' : '' }}">
                                        ...
                                        <input type="number" class="form-control" id="company" name="age" placeholder="E.g 35">
                                        @if ($errors->has('age'))
                                            <span class="help-block">
                                    ...
                                    <div class="form-group {{ $errors->has('relative') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="company" name="relative" placeholder="E.g Theresa">
                                    ...
                                    <div class="form-group {{ $errors->has('relative_contact') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" id="phone2" name="relative_contact" class="form-control">
                                    ...
                                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        <input type="email" class="form-control" id="if-email" name="email" placeholder="E.g johndoe@example.com">
                                        @if ($errors->has('email'))
                                            <span class="help-block">
                                    ...
                                    <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="vat" name="address" placeholder="Eg. P.o box****">
                                    ...
                                    <div class="form-group {{ $errors->has('occupation') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="voter" name="occupation" placeholder="Eg. Nurse">
                                    ...
                                    <div class="form-group {{ $errors->has('hometown') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="vat" name="hometown" placeholder="Eg. Aworshie Alang Taxi Rank">
                                    ...
                                    <div class="form-group {{ $errors->has('city') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="vat" name="city" placeholder="Eg. Accra Mall">
                                        @if ($errors->has('city'))
                                            <span class="help-block">
                            ...
                            <div class="row no-print">
                                <div class="col-xs-12">
                                    <a href="{{ url('system-mgmt/groups') }}" target="" class="btn btn-default"><i class="fa fa-close"></i>Cancel</a>
