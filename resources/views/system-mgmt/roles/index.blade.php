                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <h2><i class="fa fa-user"></i><span class="break"></span>Roles and Duties in Church </h2>
                            <div class="panel-actions">
                                <a href="table.html#" class="btn-setting"><i class="fa fa-edit"></i><b> <button class="btn btn-info col-sm-6 col-xs-6 btn-margin">Add Roles</button></a></b></a>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="10">
                                        <a class="btn btn-info" href="{{ route('roles.index', $role->id)}}"
                                    ...
                                    <td width="10">
                                        ...
                                        <form action="{{ route('roles.destroy', $role->id)}}" method="post" onsubmit ="return confirm('Please are you sure?')" >
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><strong>Roles In Church</strong> Details</h2>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="role_name" class="form-control" value="{{ old('role_name') }}" placeholder="Roles or Duty in church">
                                             @error('role_name')
