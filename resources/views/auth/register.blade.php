            ...
            <div class="row">
                <div class="login-box">
                    ...
                    <div class="text-with-hr">
                      ...
                      <form id="register" class="form-horizontal login" action="{{ route('register') }}" method="post">
                            ...
                            <div class="form-group">
                                <div class="controls row">
                                    <div class="input-group col-sm-12">
                                        <input type="text" class="form-control @error('fullname') is-invalid @enderror" name="fullname" id="fullname" placeholder="Full name" value="{{ old('username') }}" required data-parsley-pattern="[a-zA-Z]+$" data-parsley-trigger="keyup"/>
...
<div class="form-group">
 <div class="controls row">
 <div class="input-group col-sm-12">
<input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" placeholder="Username" value="{{ old('username') }}" required data-parsley-pattern="[a-zA-Z]+$" data-parsley-trigger="keyup"/>
<span class="input-group-addon"><i class="fa fa-lock"></i></span>
...
<div class="input-group col-sm-12">
 <input type="password" class="form-control  @error('password') is-invalid @enderror" id="password" placeholder="Password" name="password" required data-parsley-length="[8,16]" data-parsley-trigger="keyup"/>
   <span class="input-group-addon"><i class="fa fa-key"></i></span>
     ...
     <div class="controls row">
    <div class="input-group col-sm-12">
     <input type="password" class="form-control  @error('password') is-invalid @enderror" id="password" placeholder="Confirm Password" name="password_confirmation" required data-parsley-equalto="#password" data-parsley-trigger="keyup"/>
    <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                    </div>
                                </div>
                            </div>
        ...
        @endif
                     ...
                     <a class="pull-right" href="{{route('login')}}"><b>Sign In!</b></a>
                    <hr>
...
$(document).ready(function(){
 ...
 $('#register').on('subm', function(event){
  event.preventDefault();

  if($('#register').parsley().isValid())
  {
   $.ajax({
    url: '{{ route("register") }}',
    method:"POST",
