                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <h2><i class="fa fa-user"></i><span class="break"></span>Service Type</h2>
                            <div class="panel-actions">
                                <a href="table.html#" class="btn-setting"><i class="fa fa-edit"></i><b> <button class="btn btn-info col-sm-6 col-xs-6 btn-margin">Add</button></b></a>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                             ...
                             <form action="{{ route('category.destroy', $category->id)}}" method="post" onsubmit ="return confirm('Please are you sure?')">
                              @csrf
                               @method('DELETE')
                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><strong>Add Service Type</strong></h2>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="cat_name" class="form-control" value="{{ old('cat_name') }}" placeholder="Service Type">
                                             @error('cat_name')
