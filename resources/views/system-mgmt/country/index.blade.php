            ...
            <div class="sidebar col-md-2 col-sm-1">
                ...
                <div class="sidebar-collapse collapse">
                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li><a class="submenu" href="{{ url('system-management/programs') }}"><i class="fa fa-home"></i><span class="hidden-sm text">Home Cells</span>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <h2><i class="fa fa-user"></i><span class="break"></span>Country Around the Globe</h2>
                            <div class="panel-actions">
                                <a href="table.html#" class="btn-setting"><i class="fa fa-edit"></i><b> <button class="btn btn-info col-sm-5 col-xs-5 btn-margin">Add Country</button></a></b></a>
                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><strong>Add Country</strong> Details</h2>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="name" class="form-control" value="{{ old('name') }}" placeholder="Country Name">
                                             @error('name')
