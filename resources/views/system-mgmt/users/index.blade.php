...
<div class="container-fluid content">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <div class="panel-actions">
                                <a href="table.html#" class="btn-setting"><i class="fa fa-edit"></i><b> <button class="btn btn-info col-sm-5 col-xs-5 btn-margin">Add Users</button></a></b></a>
                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><strong>Add Login</strong> Details</h2>
                        </div>
                        <div class="panel-body">
                            <form action="{{ route('users.index') }}" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="fullname" class="form-control" value="{{ old('fullname') }}" placeholder="Full Name">
                                             @error('fullname')
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="username" class="form-control" value="{{ old('username') }}"placeholder="Username">
                                             @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input type="email" id="input2-group1" name="email" class="form-control" value="{{ old('email') }}"placeholder="Email">
                                ...
                                @enderror
                                 ...
                                 <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input type="password" id="input2-group1" name="password" class="form-control" value="{{ old('password') }}"placeholder="Password">
                                ...
                                @enderror
                                 ...
                                 <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input type="password" id="input2-group1" name="password_confirmation" class="form-control" placeholder="Confirm Password">
                                            <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        </div>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input type="number" id="input2-group1" name="is_admin" class="form-control" value="{{ old('is_admin') }}" placeholder="1/0">
                                            <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                             @error('is_admin')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
    ...
    <footer>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                &copy; 2020 WizzyLabs. <a href="http://bootstrapmaster.com/"></a> by CodeBrainGh
            </div><!--/.col-->
