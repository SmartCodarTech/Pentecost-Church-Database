...
<li><a class="submenu" href="{{ url('system-management/programs') }}"><i class="fa fa-laptop"></i><span class="hidden-sm text">School Programs</span>  <span class="badge">  {{DB::table('programs')->count()}}</span></a></li>
                        ...
                        <li><a class="submenu" href="{{ url('system-management/skills') }}"><i class="fa fa-cogs">

                                </i><span class="hidden-sm text">Add Skills</span>  <span class="badge">  {{DB::table('skill_managements')->count()}}</span></a></li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <h2><i class="fa fa-user"></i><span class="break"></span>School Programs</h2>
                            <div class="panel-actions">
                                <a href="table.html#" class="btn-setting"><i class="fa fa-edit"></i><b> <button class="btn btn-info col-sm-5 col-xs-5 btn-margin">Add Programs</button></a></b></a>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    <td width="15%">{{ $prg->pro_name}}</td>

                                    <td width="10%">{{ $prg->created_at}} </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><strong>Add Program</strong> Details</h2>
                        </div>
                        <div class="panel-body">
                            <form action="{{ route('programs.index') }}" method="post" class="form-horizontal">
                                @csrf
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                            <input type="text" id="input1-group1" name="pro_name" class="form-control" value="{{ old('pro_name') }}" placeholder="Program Name">
                                             @error('pro_name')
