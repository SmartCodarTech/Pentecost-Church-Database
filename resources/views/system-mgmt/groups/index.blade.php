                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <h2><i class="fa fa-user"></i><span class="break"></span>Various Groups or Associations in Church</h2>
                            <div class="panel-actions">
                                <a href="table.html#" class="btn-setting"><i class="fa fa-edit"></i><b> <button class="btn btn-info col-sm-5 col-xs-5 btn-margin">Add Groups</button></a></b></a>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    <td>{{ $group->div_name}}</td>
                                    <td>{{ $group->created_at}} </td>


                                    <td>
                                        <a class="btn btn-info" href="{{ route('groups.edit', $group->div_name)}}"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="div_name" class="form-control" value="{{ old('div_name') }}" placeholder="Group Name">
                                             @error('div_name')
