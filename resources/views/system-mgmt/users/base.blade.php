    ...
    <div class="navbar" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="table.html#"><img src="assets/img/logo.png"></a>
            </div>
            <ul class="nav navbar-nav navbar-actions navbar-left">
                <li><a href="table.html#" id="main-menu-toggle"><i class="fa fa-bars"></i></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="table.html#"><i class="fa fa-cog"></i></a></li>
                <li><a href="table.html#"><i class="fa fa-power-off"></i></a></li>
                <li class="dropdown">
                    <a href="table.html#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="assets/img/avatar.jpg"><span class="badge">9</span></a>
                    <ul class="dropdown-menu">
                        <li class="dropdown-menu-header text-center">
                            <strong>Account</strong>
                        </li>
                        <li><a href="table.html#"><i class="fa fa-bell-o"></i> Updates <span class="label label-info">42</span></a></li>
                        <li><a href="table.html#"><i class="fa fa-envelope-o"></i> Messages <span class="label label-success">42</span></a></li>
                        <li><a href="table.html#"><i class="fa fa-tasks"></i> Tasks <span class="label label-danger">42</span></a></li>
                        <li><a href="table.html#"><i class="fa fa-comments"></i> Comments <span class="label label-warning">42</span></a></li>
                        <li class="dropdown-menu-header text-center">
                            <strong>Settings</strong>
                        </li>
                        <li><a href="table.html#"><i class="fa fa-user"></i> Profile</a></li>
                        <li><a href="table.html#"><i class="fa fa-wrench"></i> Settings</a></li>
                        <li><a href="table.html#"><i class="fa fa-usd"></i> Payments <span class="label label-default">42</span></a></li>
                        <li><a href="table.html#"><i class="fa fa-file"></i> Projects <span class="label label-primary">42</span></a></li>
                        <li class="divider"></li>
                        <li><a href="table.html#"><i class="fa fa-shield"></i> Lock Profile</a></li>
                        <li><a href="table.html#"><i class="fa fa-lock"></i> Logout</a></li>    
                    </ul>
                </li>
                <li><a href="table.html#"><i class="fa fa-bars"></i></a></li>
            </ul>
            ...
            <div class="sidebar col-md-2 col-sm-1 minified">
                ...
                <div class="sidebar-collapse collapse">
                   ...
                   <li><a href="{{url('dashboard')}}"><i class="fa fa-bar-chart-o"></i><span class="hidden-sm text"> Dashboard</span></a></li> 
                        ...
                        <li>
<li><a class="submenu" href="{{ url('system-management/category') }}"><i class="fa fa-list"></i><span class="hidden-sm text">Job Categories</span>  <span class="badge">  {{DB::table('job_categories')->count()}}</span></a></li>
...
<li><a class="submenu" href="{{ url('system-management/regions') }}"><i class="fa fa-map-marker"></i><span class="hidden-sm text">Regions</span>  <span class="badge">  {{DB::table('regions')->count()}}</span></a></li>
 ...
 <li><a class="submenu" href="{{ url('system-management/schools') }}"><i class="fa fa-building-o"></i><span class="hidden-sm text">School Management</span>   <span class="badge">  {{DB::table('schools')->count()}}</span></a></li>

<li><a class="submenu" href="{{ url('system-management/programs') }}"><i class="fa fa-laptop"></i><span class="hidden-sm text">School Programs</span>  <span class="badge">  {{DB::table('programs')->count()}}</span></a></li>

<li><a class="submenu" href="{{ url('system-management/organization') }}"><i class="fa fa-umbrella"></i><span class="hidden-sm text">Organization Types</span>  <span class="badge">  {{DB::table('organization_types')->count()}}</span></a></li>
                                

    <li><a class="submenu" href="{{ url('system-management/company') }}"><i class="fa fa-suitcase"></i><span class="hidden-sm text">Organizations</span>  <span class="badge">  {{DB::table('organizations')->count()}}</span></a></li>


    <li><a class="submenu" href="{{ url('system-management/employees') }}"><i class="fa fa-users"></i><span class="hidden-sm text">Employees</span>  <span class="badge">  {{DB::table('job_finders')->count()}}</span></a></li>


 <li><a class="submenu" href="{{ url('system-management/jobs') }}"><i class="fa fa-upload"></i><span class="hidden-sm text">Jobs Avialiable</span>  <span class="badge">  {{DB::table('jobs')->count()}}</span></a></li>


<li><a class="submenu" href="{{ url('system-management/apply') }}"><i class="fa fa-ticket"></i><span class="hidden-sm text">Applied Jobs</span>  <span class="badge">  {{DB::table('apply_jobs')->count()}}</span></a></li>


<li><a class="submenu" href="{{ url('system-management/payment') }}"><i class="fa fa-money"></i><span class="hidden-sm text">Payments</span>  <span class="badge">  {{DB::table('countries')->count()}}</span></a></li>
...
<li><a class="submenu" href="{{ url('/system-management/users') }}"><i class="fa fa-user"></i><span class="hidden-sm text">Users Management</span>  <span class="badge">  {{DB::table('users')->count()}}</span></a></li>
            ...
            <!-- start: Content -->
            <div class="col-md-10 col-sm-11 main sidebar-minified">
