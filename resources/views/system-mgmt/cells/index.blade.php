                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <h2><i class="fa fa-user"></i><span class="break"></span>Cell Centers</h2>
                            <div class="panel-actions">
                                <a href="table.html#" class="btn-setting"><i class="fa fa-edit"></i><b> <button class="btn btn-info col-sm-5 col-xs-5 btn-margin">Add Cells</button></a></b></a>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $cell->cell_center}}</td>
                                    <td>{{ $cell->cell_location}}</td>
                                    <td>{{ $cell->cell_leader}}</td>
                                    <td>{{ $cell->created_at}} </td>


                                    <td>
                                        <a class="btn btn-info" href="{{ route('cells.index', $cell->id)}}"
                             ...
                             <form action="{{ route('cells.destroy', $cell->id)}}" method="post" onsubmit ="return confirm('Please are you sure?')">
                              @csrf
                               @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Pent Database</h4>
                </div>
                <div class="modal-body">

                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><strong>Add Cell</strong> Centers</h2>
                        </div>
                        <div class="panel-body">
                            <form action="{{ route('cells.index') }}" method="post" class="form-horizontal">
                                @csrf
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                            <input type="text" id="input1-group1" name="cell_name" class="form-control" value="{{ old('cell_name') }}" placeholder="Cell Name">
                                             @error('cell_name')
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="cell_center" class="form-control" value="{{ old('cell_center') }}" placeholder="Cell Center">
                                            @error('cell_center')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="cell_location" class="form-control" value="{{ old('cell_location') }}" placeholder="Cell Location">
                                            @error('cell_location')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="cell_leader" class="form-control" value="{{ old('cell_leader') }}" placeholder="Cell Leader's Name">
                                            @error('cell_leader')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <form action="" method="post" class="form-horizontal ">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                            <input type="text" id="input1-group1" name="name" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
