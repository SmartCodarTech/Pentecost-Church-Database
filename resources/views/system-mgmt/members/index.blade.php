                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" data-original-title>
                            ...
                            <h2><i class="fa fa-users"></i><span class="break"></span>List of Members</h2>
                            <div class="panel-actions">
                                <a href="{{('members/create')}}"><button class="btn btn-info col-sm-9 col-xs-9 btn-margin">Create Members</button></a><i class="fa fa-edit"></i>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    <td> <div style="text-align: center;"><img class="profile-user-img img-responsive img-circle" src="<?php echo asset("storage/$finder->photo ")?>" width="70" height="70"></div></td>
                                    <td>{{ $finder->firstname}} {{ $finder->lastname}}</td>
                                    <td>{{ $finder->birthdate}}</td>
                                    <td>{{ $finder->marital_status}}</td>
                                    <td>{{ $finder->phone}}</td>
                                    <td>{{ $finder->email}}</td>
                                    <td>{{ $finder->address}}</td>

                                    <td>{{ $finder->nationality}}</td>
                                    <td>{{ $finder->region}}</td>
                                    <td>{{ $finder->city}}</td>
                                    <td>{{ $finder->created_at}} </td>



                                    <td><a class="btn btn-success" href="{{ route('members.show', $finder->id)}}">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </td>

                                    <td><a class="btn btn-info" href="{{ route('members.edit', $finder->id)}}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                    </td>
                                    <td>

                             <form action="{{ route('members.destroy', $finder->id)}}" method="post" onsubmit ="return confirm('Please are you sure?')">
                              @csrf
                               @method('DELETE')
                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><strong>Add Job Category</strong> Details</h2>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="input1-group1" name="name" class="form-control" value="{{ old('name') }}" placeholder="Category Name">
                                             @error('name')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Update Job Category</h4>
      </div>
      <div class="modal-body">
        <div class="panel-body">
                            <form action="" method="post" class="form-horizontal ">
